...
public class AddressRepository {
    ...
    public void init() throws SQLException {
        ...
        try {
            ...
            try {
                statement.execute("create table if not exists address (id integer generated by default as identity primary key, street varchar(255), city varchar(255), state varchar(255), zip varchar(255))");
            } finally {
                statement.close();
            }
        } finally {
